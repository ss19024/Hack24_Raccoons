...
namespace Rokid.UXR.Module
{
    ...
    public struct TrackableChanges<T> : IDisposable where T : struct
    {
        /// <summary>
        ...
        /// </summary>
        public NativeArray<T> removed => m_Removed;
            ...
            Allocator allocator)
        {
            ...
            m_Removed = new NativeArray<T>(removedCount, allocator);
            isCreated = true;
        }
            ...
            Allocator allocator)
        {
            ...
            m_Removed = NativeCopyUtility.PtrToNativeArrayWithDefault<T>(defaultT, removedPtr, stride, removedCount, allocator);
            isCreated = true;
        }
            ...
            Allocator allocator)
        {
            ...
            var removedCopy = new NativeArray<T>(removed.Length, allocator);
